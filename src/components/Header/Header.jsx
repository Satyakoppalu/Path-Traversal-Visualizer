...
class Header extends Component{
    ...
    render(){
        ...
        return (
            ...
            <Navbar.Brand href="">Path Traversal Visualizer</Navbar.Brand>
            ...
            <Nav className="mr-auto">
                ...
                onClick={()=> this.props.visualize('dijsstra') } disabled={this.props.isVisualizing} href="">Dijkstra</Nav.Link>
